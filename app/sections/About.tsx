    ...
    >
      ...
      <div className="flex flex-col  lg:flex-row w-full py-10  gap-10">
        <div className="w-full lg:w-[50%] flex flex-col gap-2 order-2 lg:order-1">
          <h4 className="font-bold ">Tools of my Expertise</h4>
        ...
        <div className="w-full lg:w-[50%] order-1 lg:order-2">
          <article>
          I’m exploring opportunities in product roles, with experience as a Product Analyst at Cogoport and internships in strategy and management. I’m passionate about product management, AI, and tech for product managers. Lately, I’ve picked up hobbies like generating AI images, testing new tools, and writing actively on Medium and LinkedIn.

{" "}
            <br />
            <br />
            I enjoy solving problems, analyzing data, and learning something new every day. My goal is to create meaningful products that solve real-world problems and deliver value to users.
          </article>
        </div>
      </div>
    </section>
